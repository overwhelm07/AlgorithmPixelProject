...
public class PixelPlayer11 extends Player {
    PixelPlayer11(int[][] map) {
        super(map);
    }
    ...
    public Point nextPosition(Point lastPosition) {
        ...
        if(firstChk){
            ...
            if((x==0||y==1)&&map[0][1]==0&&!isfour(0, 1))
                return new Point(0, 1);
            else if((x==1||y==0)&&map[1][0]==0&&!isfour(1, 0))
                return new Point(1, 0);
            else if((x==0||y==6)&&map[0][6]==0&&!isfour(0, 6))
                return new Point(0, 6);
            else if((x==1||y==7)&&map[1][7]==0&&!isfour(1, 7))
                return new Point(1, 7);
            else if((x==6||y==0)&&map[6][0]==0&&!isfour(6, 0))
                return new Point(6, 0);
            else if((x==7||y==1)&&map[7][1]==0&&!isfour(7, 1))
                return new Point(7, 1);
            else if((x==6||y==7)&&map[6][7]==0&&!isfour(6, 7))
                return new Point(6, 7);
            else if((x==7||y==6)&&map[7][6]==0&&!isfour(7, 6))
                return new Point(7, 6);
            else if((x==1||y==1)&&map[1][1]==0&&!isfour(1, 1))
                return new Point(1, 1);
            else if((x==1||y==6)&&map[1][6]==0&&!isfour(1, 6))
                return new Point(1, 6);
            else if((x==6||y==1)&&map[6][1]==0&&!isfour(6, 1))
                return new Point(6, 1);
            else if((x==6||y==6)&&map[6][6]==0&&!isfour(6, 6)){
                //firstChk = false;
    ...
    근데 그 돌의 거리가 내 지점에서 한칸씩 떨어질때마다 -10씩함
     */
    public void chkMyCnt(int x, int y) {
        ...
        while (isAvailRange2(tmpx, ++tmpy)) {
            distance+=10;
            if (map[tmpx][tmpy] == myNum) myCnt+=(100-distance);
    ...
    public void chkYourCnt(int x, int y) {
        ...
        while (isAvailRange2(tmpx, ++tmpy)) {
            distance+=10;
            if (map[tmpx][tmpy] == yourNum) yourCnt+=(50-distance);
