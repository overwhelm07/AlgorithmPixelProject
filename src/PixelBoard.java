...
public class PixelBoard extends JComponent{
	...
	public void paintComponent(Graphics g) {
		...
		snumberOfblueDol = numberOfblueDol + "move";
		snumberOfredDol = numberOfredDol + "move";
		g2.drawString(snumberOfblueDol, 710, 130);
		g2.drawString(snumberOfredDol, 710, 580);
		...
		g2.drawString("performance time(mean) : ", 610, 168);
		g2.drawString(p1TimeString, 610, 183);
		g2.drawString("performance time(mean) : ", 610, 615);
